...
- **텍스트 라벨 편집**: 텍스트 에디터로 어노테이션 직접 수정
- **비주얼 라벨 편집**: 마우스로 바운딩 박스를 직접 그리고 편집
...
- **키보드 조작**:
  ...
  - `ESC`: 저장하고 종료
  - `q`: 저장하지 않고 종료
- **클래스 선택**: 새 바운딩 박스 그릴 때 클래스 선택 프롬프트 표시
- **시각적 피드백**: 선택된 박스는 빨간색으로 표시
