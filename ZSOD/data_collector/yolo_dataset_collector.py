...
class YOLODatasetCollector(Node):
    def __init__(self):
        ...
        #                    "tv", "tv stand", "vanity"]
        self.class_names = ['airconditioner', 'bed', 'bookshelf', 'cabinet', 'chair', 'clock', 'curtain', 'desk', 'door', 'dresser', 'lamp', 'monitor', 'plant', 'sofa', 'table', 'television', 'wallpainting', 'window']
